...
describe('Repo Testing: ', () => {
    ...
    describe('Preparing...', () => {
        ...
        it('Should return new todoService', done => {
            todoService = new TodoService_1.TodoService(mongoRepo);
    ...
    describe('Testing Repo methods', () => {
        before(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            addedTestTodos = yield Promise.all(testTodos.map((todo) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                return yield mongoRepo.addNewTodo(todo);
            })));
        }));
        after(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            yield Promise.all(addedTestTodos.map((todo) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return yield mongoRepo.deleteTodoById(todo._id); })));
        }));
